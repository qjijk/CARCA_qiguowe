...
def multihead_attention(queries, 
    ...
    with tf.compat.v1.variable_scope(scope, reuse=reuse):
        ...
        # Linear projections
        Q = tf.compat.v1.layers.dense(queries, num_units, activation=tf.nn.leaky_relu) # (N, T_q, C)
        K = tf.compat.v1.layers.dense(keys, num_units, activation=tf.nn.leaky_relu) # (N, T_k, C)
        V = tf.compat.v1.layers.dense(keys, num_units, activation=tf.nn.leaky_relu) # (N, T_k, C)
        #Q = tf.layers.dense(queries, num_units, activation=None) # (N, T_q, C)
        #K = tf.layers.dense(keys, num_units, activation=None) # (N, T_k, C)
        #V = tf.layers.dense(keys, num_units, activation=None) # (N, T_k, C)
        
        # Split and concat
        Q_ = tf.compat.v1.concat(tf.compat.v1.split(Q, num_heads, axis=2), axis=0) # (h*N, T_q, C/h) 
        K_ = tf.compat.v1.concat(tf.compat.v1.split(K, num_heads, axis=2), axis=0) # (h*N, T_k, C/h) 
        V_ = tf.compat.v1.concat(tf.compat.v1.split(V, num_heads, axis=2), axis=0) # (h*N, T_k, C/h) 
...
class Model():
    def __init__(self, usernum, itemnum, args, ItemFeatures=None, UserFeatures=None, cxt_size=None, reuse=None , use_res=False):
        ...
        self.u = tf.compat.v1.placeholder(tf.int32, shape=(None, args.maxlen))
        ...
        self.seq_cxt = tf.compat.v1.placeholder(tf.float32, shape=(None, args.maxlen, cxt_size))
        self.pos_cxt = tf.compat.v1.placeholder(tf.float32, shape=(None, args.maxlen, cxt_size))
        self.neg_cxt = tf.compat.v1.placeholder(tf.float32, shape=(None, args.maxlen, cxt_size))
        ...
        #cxt
        self.seq_feat_emb = tf.compat.v1.layers.dense(inputs=self.seq_feat_in, units=args.hidden_units*5,activation=None, kernel_initializer=tf.random_normal_initializer(stddev=0.01) , name="feat_emb")
        #### Features Part
        ...
        self.seq = tf.compat.v1.layers.dense(inputs=self.seq_concat, units=args.hidden_units,activation=None, kernel_initializer=tf.random_normal_initializer(stddev=0.01), name='embComp')
        #### Features Part  
        #### Cxt part
        ...
        ##
        pos_feat_emb = tf.compat.v1.layers.dense(inputs=pos_feat, reuse=True, units=args.hidden_units*5,activation=None, kernel_initializer=tf.random_normal_initializer(stddev=0.01) , name="feat_emb")
        pos_emb_con = tf.concat([pos_emb_in, pos_feat_emb], -1)
        pos_emb = tf.compat.v1.layers.dense(inputs=pos_emb_con, reuse=True, units=args.hidden_units,activation=None, kernel_initializer=tf.random_normal_initializer(stddev=0.01), name='embComp') # 128 x 200 x h
        ...
        ##
        neg_feat_emb = tf.compat.v1.layers.dense(inputs=neg_feat, reuse=True, units=args.hidden_units*5,activation=None, kernel_initializer=tf.random_normal_initializer(stddev=0.01) , name="feat_emb")
        neg_emb_con = tf.concat([neg_emb_in, neg_feat_emb], -1)
        neg_emb = tf.compat.v1.layers.dense(inputs=neg_emb_con, reuse=True, units=args.hidden_units,activation=None, kernel_initializer=tf.random_normal_initializer(stddev=0.01), name='embComp') # 128 x 200 x h
        ...
        self.test_item_cxt = tf.compat.v1.placeholder(tf.float32, shape=(101, cxt_size))
        ...
        ########### Test user
        self.test_user = tf.compat.v1.placeholder(tf.int32, shape=(args.maxlen))
        ...
        ##
        test_feat_emb = tf.compat.v1.layers.dense(inputs=test_feat_con, reuse=True, units=args.hidden_units*5,activation=None, kernel_initializer=tf.random_normal_initializer(stddev=0.01), name="feat_emb") #1 x 101 x h
        test_item_emb_con = tf.concat([test_item_emb_in, test_feat_emb], -1)  #1 x 101 x 2h
        test_item_emb = tf.compat.v1.layers.dense(inputs=test_item_emb_con, reuse=True, units=args.hidden_units,activation=None, kernel_initializer=tf.random_normal_initializer(stddev=0.01), name='embComp')  # 1 x 101 x h
        ...
        #### Features Part
        mask_pos = tf.expand_dims(tf.compat.v1.to_float(tf.not_equal(self.pos, 0)), -1)
        mask_neg = tf.expand_dims(tf.compat.v1.to_float(tf.not_equal(self.neg, 0)), -1)


        self.test_logits = None
        for i in range(1):
            with tf.compat.v1.variable_scope("num_blocks_p_%d" % i):
        ...
        ##Without User
        self.test_logits = tf.compat.v1.layers.dense(inputs=self.test_logits, units=1,activation=None, kernel_initializer=tf.random_normal_initializer(stddev=0.01), name='logit')  # 1 x 101 x 1
        ...
        self.pos_logits = tf.compat.v1.layers.dense(inputs=self.pos_logits, reuse=True, units=1,activation=None, kernel_initializer=tf.random_normal_initializer(stddev=0.01), name='logit') 
        self.neg_logits = tf.compat.v1.layers.dense(inputs=self.neg_logits, reuse=True, units=1,activation=None, kernel_initializer=tf.random_normal_initializer(stddev=0.01), name='logit') 
